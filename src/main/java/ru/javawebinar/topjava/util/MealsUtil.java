...
public class MealsUtil {
    ...
    public static final List<Meal> meals2 = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 0, 0), "Еда на граничное значение", 100),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 20, 0), "Ужин", 410)
    );
