...
public class ExceptionInfoHandler {
    ...
    private static final String EXCEPTION_DUPLICATE_EMAIL = "error.duplicateEmail";
    private static final String EXCEPTION_DUPLICATE_DATETIME = "error.duplicateMealDateTime";
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, @Nullable List<String> details) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType,
                details == null ? List.of(rootCause.getLocalizedMessage()) : details);
    }
}